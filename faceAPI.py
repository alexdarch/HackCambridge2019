...
class FaceAPI:
    ...
    def __init__(self, face_list_id, image_url):
...
face_api = FaceAPI(face_list_id='19012019facelist', image_url="https://how-old.net/Images/faces2/main00.jpg")
...
#
# faces = find_face_in_image(image_data)